...
df <- read_csv('/nfsshare/sashls/custdata/cdiscpilot01/converted/dm.csv')

# Print the dataframe
print(df)

# Save the R dataframe as an R object
saveRDS(df, file = "/nfsshare/sashls/custdata/cdiscpilot01/converted/dm.RDS")
...
df <- read_sas('/nfsshare/sashls/custdata/cdiscpilot01/converted/dm.sas7bdat')
print(df)
...
df <- readRDS("/nfsshare/sashls/custdata/cdiscpilot01/converted/dm.rds")
